...
export function OutlineNotification({ size, fill }: Props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24" width={size} height={size}>
      <path
        fill={fill}
...
export function FilledNotification({ size, fill }: Props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" id="Filled" viewBox="0 0 24 24" width={size} height={size}>
...
export function Search({ size, fill }: Props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24" width={size} height={size}>
      <path
        fill={fill}
...
export function Sun({ size, fill }: Props) {
  return (
...
export function HalfMoon({ size, fill }: Props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width={size} height={size}>
      <path
        fill={fill}
...
export function MoneyIcon({ size, fill }: Props) {
  return (
    <svg id="Layer_1" height={size} viewBox="0 0 24 24" width={size} xmlns="http://www.w3.org/2000/svg" data-name="Layer 1">
      <path
        fill={fill}
