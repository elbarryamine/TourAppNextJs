...
const links: Array<SideLink> = [
  { icon: <FaClone size="14px" />, title: 'Dashboard', url: dashboardLinks.home },
  { icon: <FaMoneyBillAlt size="14px" />, title: 'Sales', url: dashboardLinks.sales },
  { icon: <FaShuttleVan size="14px" />, title: 'Tours', url: dashboardLinks.tours },
  { icon: <FaUsers size="14px" />, title: 'Clients', url: dashboardLinks.clients },
  { icon: <FaMailBulk size="14px" />, title: 'Mail', url: dashboardLinks.mail },
]
...
export function SideNavigation() {
  ...
  const [active, setActive] = useState<number>(startingActiveIndex !== -1 ? startingActiveIndex : 0)
